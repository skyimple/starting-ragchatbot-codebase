...
class AIGenerator:
    ...
    SYSTEM_PROMPT = """You are an AI assistant specialized in course materials with
access to a comprehensive search tool for course information.
...
- **No meta-commentary**:
 - Provide direct answers only — no reasoning process or search explanations
